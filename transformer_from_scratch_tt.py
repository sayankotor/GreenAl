...
args.logging_steps = 100.0
args.save_steps = 500
args.evaluate_during_training = True
args.output_dir = '/notebook/greenAI_gpt/new_tt64'
...
def main():
    ...
    #model.load_state_dict(torch.load('/notebook/greenAI/out_tt64_small_transformer_v2/checkpoint-2500/model_tt.pth'))
    ...
    dataset_train = TextDataset(tokenizer=tokenizer, 
                                file_path="/notebook/greenAI_gpt/wikitext-103/wiki.train.tokens", 
                                block_size=512)
    ...
    dataset_test = TextDataset(tokenizer=tokenizer, 
                                file_path="/notebook/greenAI_gpt/wikitext-103/wiki.test.tokens", block_size=512)
