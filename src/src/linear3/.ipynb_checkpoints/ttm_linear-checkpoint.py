...
from ttm_linear.ttm import TTM, forward_backward_module, einsum_forward
...
def prepare_core_shapes(
    ...
    print('-------------------------------------')
    print(f'TTM-Linear required dimensions: {dim_in=}, {dim_out=}')
    ...
    print(f'    after best_approx: {dim_in=}, {dim_out=}')
